        ...
        games?.let {
            ...
            games.zip(jsonResponse).forEach { (topGame, jsonTopGame) ->
                with(jsonTopGame.asJsonObject){
                    ...
                    Assert.assertEquals(topGame.thumb, "http://cdn.akami.steamstatic.com/steam/apps/${this["appid"].asInt}/capsule_184x69.jpg")
                }
            }
        }
    }
